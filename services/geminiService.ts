...
// Ensure we access the environment variable safely.
// In a Vite build, import.meta.env.VITE_GEMINI_API_KEY is replaced by a string.
// We add optional chaining protection against undefined import.meta.env
